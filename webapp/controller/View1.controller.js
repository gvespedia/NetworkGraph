sap.ui.define([
	...
	return Controller.extend("com.gv.ng.NetworkGraph1.controller.View1", {
		STARTING_PROFILE: "Mann",
		onInit: function() {
			...
			this._sTopSupervisor = this.STARTING_PROFILE;
		...
		_openDetail: function(oNode, oButton) {
			...
			if (!this._oQuickView) {
				this._oQuickView = sap.ui.xmlfragment("com.gv.ng.NetworkGraph1.view.Details", this);
			}
